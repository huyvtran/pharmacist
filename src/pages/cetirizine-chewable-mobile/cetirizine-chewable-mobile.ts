...
@Component({
  selector: 'page-cetirizine-chewable-mobile',
  templateUrl: 'cetirizine-chewable-mobile.html'
})
export class CetirizineChewableMobilePage {
  ...
  showMenu() {
    ...
    var setting = GlobalVars.getPageSetting('g');
  ...
  gotoDosePage() {
    this.navCtrl.push(CetirizinePage);
  }
