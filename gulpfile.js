...
gulp.task('watch', ['clean'], function(done){
  ...
  'concatcss', 'minifyprefixcss', 'copycomponents', 'minifyhtml', 'service-worker',
    function(){
      ...
      gulpWatch('src/**/*.scss', function(){ gulp.start('sass', 'minifyprefixcss'); });
      gulpWatch('src/**/*.html', function(){ gulp.start('html', 'minifyhtml'); });
      gulpWatch('src/pages/**/*.scss', function(){ gulp.start('sass', 'minifyprefixcss'); });
      gulpWatch('src/pages/**/*.html', function(){ gulp.start('html', 'minifyhtml'); });
    ...
    function(){
      ...
      buildBrowserify().on('end', function(){
        ...
        notifier.notify({
          ...
          icon: path.join(__dirname, 'www/assets/icon/favicon.ico'), // Absolute path (doesn't work on balloons)
